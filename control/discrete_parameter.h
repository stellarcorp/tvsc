...
namespace tvsc::control {
  ...
  public:
    ...
    DiscreteParameter& operator = (const T& value) { value_ = value; return *this; }
    DiscreteParameter& operator = (T&& value) { value_ = std::move(value); return *this; }
    DiscreteParameter& operator = (const DiscreteParameter& rhs) { value_ = rhs.value_; return *this;}
    DiscreteParameter& operator = (DiscreteParameter&& rhs) { value_ = std::move(rhs.value_); return *this; }
