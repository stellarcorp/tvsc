...
int main(int argc, char* argv[]) {
  ...
  scheduler.add_task(monitor_power<ClockType>(board.power_monitor1(), power_monitor1, 10ms));
  scheduler.add_task(monitor_power<ClockType>(board.power_monitor2(), power_monitor2, 10ms));
  scheduler.add_task(
