...
TEST(SettingsTypesTest, CanTranslateEnumToDiscreteValue) {
  tvsc_comms_radio_nano_ModulationTechnique initial{
      tvsc_comms_radio_nano_ModulationTechnique::tvsc_comms_radio_nano_ModulationTechnique_OOK};
  tvsc_comms_radio_nano_DiscreteValue discrete = as_discrete_value(initial);
  EXPECT_EQ(initial, as<tvsc_comms_radio_nano_ModulationTechnique>(discrete));
}
...
TEST(SettingsTypesTest, ThrowsTranslatingDiscreteValueToInappropriateTypeInt32) {
  ...
  tvsc_comms_radio_nano_DiscreteValue discrete = as_discrete_value(initial);
  // Currently, we can't distinguish between enum types and int32_t.
  // EXPECT_THROW(as<tvsc_comms_radio_nano_ModulationTechnique>(discrete), std::exception);
  EXPECT_THROW(as<int64_t>(discrete), std::exception);
  EXPECT_THROW(as<float>(discrete), std::exception);
}
...
TEST(RadioSettingsTest, CanIdentifyValidInt32ValuesInRangedCapabilityInclusiveInclusive) {
  const auto& allowed_values{int32_range(
      0, 65535,
      tvsc_comms_radio_nano_RangeInclusivity::tvsc_comms_radio_nano_RangeInclusivity_INCLUSIVE_INCLUSIVE)};
  EXPECT_TRUE(is_valid_setting(allowed_values, as_discrete_value(0)));
  EXPECT_TRUE(is_valid_setting(allowed_values, as_discrete_value(23)));
  EXPECT_TRUE(is_valid_setting(allowed_values, as_discrete_value(65535)));
  EXPECT_FALSE(is_valid_setting(allowed_values, as_discrete_value(65536)));
...
TEST(RadioSettingsTest, CanIdentifyValidInt32ValuesInRangedCapabilityInclusiveExclusive) {
  const auto& allowed_values{int32_range(
      0, 65535,
      tvsc_comms_radio_nano_RangeInclusivity::tvsc_comms_radio_nano_RangeInclusivity_INCLUSIVE_EXCLUSIVE)};
  EXPECT_TRUE(is_valid_setting(allowed_values, as_discrete_value(0)));
  EXPECT_TRUE(is_valid_setting(allowed_values, as_discrete_value(23)));
...
TEST(RadioSettingsTest, CanIdentifyValidInt32ValuesInRangedCapabilityExclusiveInclusive) {
  const auto& allowed_values{int32_range(
      0, 65535,
      tvsc_comms_radio_nano_RangeInclusivity::tvsc_comms_radio_nano_RangeInclusivity_EXCLUSIVE_INCLUSIVE)};
...
TEST(RadioSettingsTest, CanIdentifyValidInt32ValuesInRangedCapabilityExclusiveExclusive) {
  const auto& allowed_values{int32_range(
      0, 65535,
      tvsc_comms_radio_nano_RangeInclusivity::tvsc_comms_radio_nano_RangeInclusivity_EXCLUSIVE_EXCLUSIVE)};
  EXPECT_FALSE(is_valid_setting(allowed_values, as_discrete_value(0)));
  EXPECT_TRUE(is_valid_setting(allowed_values, as_discrete_value(23)));
  EXPECT_FALSE(is_valid_setting(allowed_values, as_discrete_value(65535)));
  EXPECT_FALSE(is_valid_setting(allowed_values, as_discrete_value(65536)));
...
TEST(RadioSettingsTest, CanIdentifyValidEnumerationValuesInEnumeratedCapability) {
  const auto& allowed_values{enumerated({
      tvsc_comms_radio_nano_ModulationTechnique::tvsc_comms_radio_nano_ModulationTechnique_OOK,
      tvsc_comms_radio_nano_ModulationTechnique::tvsc_comms_radio_nano_ModulationTechnique_FSK,
      tvsc_comms_radio_nano_ModulationTechnique::tvsc_comms_radio_nano_ModulationTechnique_GFSK,
      tvsc_comms_radio_nano_ModulationTechnique::tvsc_comms_radio_nano_ModulationTechnique_MSK,
      tvsc_comms_radio_nano_ModulationTechnique::tvsc_comms_radio_nano_ModulationTechnique_GMSK,
  })};
  ...
  EXPECT_FALSE(is_valid_setting(
      allowed_values,
      as_discrete_value(
          tvsc_comms_radio_nano_ModulationTechnique::tvsc_comms_radio_nano_ModulationTechnique_QPSK)));
  EXPECT_FALSE(is_valid_setting(
      allowed_values,
      as_discrete_value(
          tvsc_comms_radio_nano_ModulationTechnique::tvsc_comms_radio_nano_ModulationTechnique_DSSS)));
}
