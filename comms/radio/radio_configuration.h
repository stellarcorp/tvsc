...
std::unordered_map<tvsc_comms_radio_nano_Function, tvsc_comms_radio_nano_Value> generate_capabilities_map();
 ...
 */
template <typename DriverT>
tvsc_comms_radio_nano_DiscreteValue read_setting(DriverT& driver, tvsc_comms_radio_nano_Function function);
 ...
 */
template <typename DriverT>
void write_setting(DriverT& driver, tvsc_comms_radio_nano_Function function,
...
void write_settings(DriverT& driver,
                    const std::unordered_map<tvsc_comms_radio_nano_Function,
                                             tvsc_comms_radio_nano_DiscreteValue>& pending_settings) {
 ...
 */
template <typename DriverT>
std::unordered_map<tvsc_comms_radio_nano_Function, tvsc_comms_radio_nano_DiscreteValue> default_configuration();

inline void print_id(const tvsc_comms_radio_nano_RadioIdentification& id) {
...
class RadioConfiguration final {
 private:
  ...
  const std::unordered_map<tvsc_comms_radio_nano_Function, tvsc_comms_radio_nano_Value> capabilities_;
  tvsc_comms_radio_nano_RadioIdentification identification_{};

  std::unordered_map<tvsc_comms_radio_nano_Function, tvsc_comms_radio_nano_DiscreteValue>
      pending_settings_changes_{};

  static tvsc_comms_radio_nano_RadioIdentification generate_identification(std::string_view name) {
 ...
 public:
  ...
  RadioConfiguration(DriverT& driver, const tvsc_comms_radio_nano_RadioIdentification& identification)
      : driver_(&driver),
        capabilities_(generate_capabilities_map<DriverT>()),
  ...
  const tvsc_comms_radio_nano_RadioIdentification& identification() const { return identification_; }
  tvsc_comms_radio_nano_RadioIdentification& identification() { return identification_; }
  void regenerate_identifiers() { identification_ = generate_identification(identification_.name); }

  tvsc_comms_radio_nano_Settings settings() const { return {}; }
  tvsc_comms_radio_nano_Capabilities capabilities() const { return {}; }

  std::vector<tvsc_comms_radio_nano_Function> get_configurable_functions() const {
    std::vector<tvsc_comms_radio_nano_Function> functions{};
  ...
  tvsc_comms_radio_nano_Value get_valid_values(tvsc_comms_radio_nano_Function function) const {
    return capabilities_.at(function);
  }

  tvsc_comms_radio_nano_DiscreteValue get_value(tvsc_comms_radio_nano_Function function) const {
    return read_setting<DriverT>(*driver_, function);
  }

  const tvsc_comms_radio_nano_DiscreteValue& get_pending_value(tvsc_comms_radio_nano_Function function) const {
    return pending_settings_changes_.at(function);
  }

  void change_value(tvsc_comms_radio_nano_Function function, const tvsc_comms_radio_nano_DiscreteValue& value) {
  ...
  void change_values(
      const std::unordered_map<tvsc_comms_radio_nano_Function, tvsc_comms_radio_nano_DiscreteValue>& values) {
