...
template <>
inline std::unordered_map<tvsc_radio_nano_Function, tvsc_radio_nano_Value>
generate_capabilities_map<RF69HCW>() {
  std::unordered_map<tvsc_radio_nano_Function, tvsc_radio_nano_Value> capabilities{};
  ...
  capabilities.insert(
      {tvsc_radio_nano_Function_CARRIER_FREQUENCY_HZ, float_range(405'000'000, 510'000'000)});
  ...
  capabilities.insert({tvsc_radio_nano_Function_MTU, int32_range(1, 60)});

  capabilities.insert({tvsc_radio_nano_Function_PREAMBLE_LENGTH, int32_range(0, 0xffff)});

  capabilities.insert({tvsc_radio_nano_Function_SYNC_WORDS_LENGTH, int32_range(0, 8)});

  capabilities.insert(
      {tvsc_radio_nano_Function_LINE_CODING,
       enumerated({tvsc_radio_nano_LineCoding_NONE, tvsc_radio_nano_LineCoding_MANCHESTER_ORIGINAL,
                   tvsc_radio_nano_LineCoding_WHITENING})});

  capabilities.insert(
      {tvsc_radio_nano_Function_ENCRYPTION,
       enumerated({tvsc_radio_nano_Encryption_NO_ENCRYPTION, tvsc_radio_nano_Encryption_AES_128})});

  capabilities.insert({tvsc_radio_nano_Function_BIT_RATE,
                       float_range(RF69HCW::RF69HCW_FXOSC / 0xffff, RF69HCW::RF69HCW_FXOSC)});

  capabilities.insert({tvsc_radio_nano_Function_FREQUENCY_DEVIATION,
                       float_range(600.f, 0x3fff * RF69HCW::RF69HCW_FSTEP)});

  capabilities.insert(
      {tvsc_radio_nano_Function_RECEIVE_SENSITIVITY_THRESHOLD_DBM, float_range(-127.5f, 0.f)});

  capabilities.insert(
      {tvsc_radio_nano_Function_CHANNEL_ACTIVITY_THRESHOLD_DBM, float_range(-127.5f, 0.f)});

  return capabilities;
}

inline void set_frequency_hz(RF69HCW& driver, const tvsc_radio_nano_DiscreteValue& value) {
...
inline void set_preamble_length(RF69HCW& driver, const tvsc_radio_nano_DiscreteValue& value) {
...
inline void set_sync_words_length(RF69HCW& driver, const tvsc_radio_nano_DiscreteValue& value) {
...
inline void set_power_dbm(RF69HCW& driver, const tvsc_radio_nano_DiscreteValue& value) {
...
inline void set_modulation_scheme(RF69HCW& driver, const tvsc_radio_nano_DiscreteValue& value) {
  tvsc_radio_nano_ModulationTechnique modulation{as<tvsc_radio_nano_ModulationTechnique>(value)};
...
inline void set_line_coding(RF69HCW& driver, const tvsc_radio_nano_DiscreteValue& value) {
  tvsc_radio_nano_LineCoding coding{as<tvsc_radio_nano_LineCoding>(value)};
...
inline void set_bit_rate(RF69HCW& driver, const tvsc_radio_nano_DiscreteValue& value) {
...
inline tvsc_radio_nano_DiscreteValue read_setting<RF69HCW>(RF69HCW& driver,
  ...
  switch (function) {
    ...
    case tvsc_radio_nano_Function_PREAMBLE_LENGTH: {
      get_preamble_length(driver, value);
      break;
    }
    case tvsc_radio_nano_Function_SYNC_WORDS_LENGTH: {
      get_sync_words_length(driver, value);
      break;
    }
    case tvsc_radio_nano_Function_TX_POWER_DBM: {
      get_power_dbm(driver, value);
      break;
    }
    case tvsc_radio_nano_Function_MODULATION_SCHEME: {
      get_modulation_scheme(driver, value);
      break;
    }
    case tvsc_radio_nano_Function_LINE_CODING: {
      get_line_coding(driver, value);
      break;
    }
    case tvsc_radio_nano_Function_BIT_RATE: {
      get_bit_rate(driver, value);
      break;
    }
    case tvsc_radio_nano_Function_FREQUENCY_DEVIATION: {
      get_frequency_deviation_hz(driver, value);
      break;
    }
    case tvsc_radio_nano_Function_RECEIVE_SENSITIVITY_THRESHOLD_DBM: {
      get_receive_sensitivity_threshold_dbm(driver, value);
      break;
    }
    case tvsc_radio_nano_Function_CHANNEL_ACTIVITY_THRESHOLD_DBM: {
...
template <>
inline void write_setting<RF69HCW>(RF69HCW& driver, tvsc_radio_nano_Function function,
                                   const tvsc_radio_nano_DiscreteValue& value) {
  switch (function) {
    case tvsc_radio_nano_Function_CARRIER_FREQUENCY_HZ: {
...
high_throughput_configuration() {
  ...
  configuration.insert(
      {tvsc_radio_nano_Function_CARRIER_FREQUENCY_HZ, tvsc::radio::as_discrete_value(433e6f)});

  configuration.insert(
      {tvsc_radio_nano_Function_TX_POWER_DBM, tvsc::radio::as_discrete_value<int8_t>(13)});
  ...
  configuration.insert(
      {tvsc_radio_nano_Function_PREAMBLE_LENGTH, tvsc::radio::as_discrete_value<uint16_t>(0x08)});
  ...
  configuration.insert(
      {tvsc_radio_nano_Function_SYNC_WORDS_LENGTH, tvsc::radio::as_discrete_value<uint8_t>(2)});

  configuration.insert({tvsc_radio_nano_Function_MODULATION_SCHEME,
                        tvsc::radio::as_discrete_value(tvsc_radio_nano_ModulationTechnique_GFSK)});
  ...
  // cycles.
  configuration.insert({tvsc_radio_nano_Function_LINE_CODING,
                        tvsc::radio::as_discrete_value(tvsc_radio_nano_LineCoding_WHITENING)});

  const float bit_rate{290000.f};
  const float freq_dev = std::min(500000.f - bit_rate / 2.f, 1.4f * bit_rate);

  configuration.insert(
      {tvsc_radio_nano_Function_BIT_RATE, tvsc::radio::as_discrete_value<float>(bit_rate)});
  ...
  configuration.insert(
      {tvsc_radio_nano_Function_FREQUENCY_DEVIATION, as_discrete_value<float>(freq_dev)});
...
standard_configuration() {
  ...
  // this particular setting.
  configuration.insert(
      {tvsc_radio_nano_Function_PREAMBLE_LENGTH, tvsc::radio::as_discrete_value<uint16_t>(0x10)});
  ...
  // The transmitter and receiver must agree both on length and content of the sync words.
  configuration.insert(
      {tvsc_radio_nano_Function_SYNC_WORDS_LENGTH, tvsc::radio::as_discrete_value<uint8_t>(8)});

  configuration.insert({tvsc_radio_nano_Function_MODULATION_SCHEME,
                        tvsc::radio::as_discrete_value(tvsc_radio_nano_ModulationTechnique_FSK)});
