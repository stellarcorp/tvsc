...
template <typename T>
inline tvsc_radio_nano_Value enumerated(std::initializer_list<T> values) {
  tvsc_radio_nano_Value result{};
...
template <>
inline tvsc_radio_nano_Value enumerated<int32_t>(std::initializer_list<int32_t> values) {
  tvsc_radio_nano_Value result{};
  result.discrete_count = values.size();
...
template <>
inline tvsc_radio_nano_Value enumerated<int64_t>(std::initializer_list<int64_t> values) {
  tvsc_radio_nano_Value result{};
  result.discrete_count = values.size();
...
template <>
inline tvsc_radio_nano_Value enumerated<float>(std::initializer_list<float> values) {
  tvsc_radio_nano_Value result{};
  result.discrete_count = values.size();
...
template <typename T>
inline T as(const tvsc_radio_nano_DiscreteValue& value) {
  ...
  if (value.which_value == 0) {
    if (range.which_value == 0) {
      ...
      switch (typed_range.inclusive) {
        ...
        case tvsc_radio_nano_RangeInclusivity_INCLUSIVE_EXCLUSIVE:
          return typed_range.min <= value.value.int32_value &&
                 value.value.int32_value < typed_range.max;
        case tvsc_radio_nano_RangeInclusivity_EXCLUSIVE_INCLUSIVE:
          return typed_range.min < value.value.int32_value &&
                 value.value.int32_value <= typed_range.max;
        case tvsc_radio_nano_RangeInclusivity_EXCLUSIVE_EXCLUSIVE:
          return typed_range.min < value.value.int32_value &&
                 value.value.int32_value < typed_range.max;
      }
    } else {
 ...
 */
inline bool is_valid_setting(const tvsc_radio_nano_Value& allowed_values,
                             const tvsc_radio_nano_DiscreteValue& value) {
